...
(--- VALIDATE I < J ---) 
( I must be less than J or ASIN[#4/#5] would exceed 90 deg   )
...
(============================================================)
#105 = ASIN[#4 / #5] (PHI MAX IN DEGREES - NOT USED IN LOOP)
